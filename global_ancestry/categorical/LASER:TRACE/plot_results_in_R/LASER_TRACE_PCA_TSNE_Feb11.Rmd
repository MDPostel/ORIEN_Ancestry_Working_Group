...
Both <- read.csv('../admix/HGDP_1000GP_Q_K8.csv', header = TRUE)
...
## Set dimension
D=2 #or 3
tsne_model_1 = Rtsne(as.matrix(data_tsne[,c(4:11)]), check_duplicates=FALSE, pca=TRUE, perplexity=30, theta=0.5, dims=D)
