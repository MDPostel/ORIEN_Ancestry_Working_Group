...
```{r}
Q1 <- read.table("HGDP_1000GP_Apr2022.20.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
p
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
...
p2
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_PUR.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
...
p3 <- p + geom_point(data=MXL, 
             ...
             size=0.05)
p3
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_MXL.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
...
p4 <- p + geom_point(data=PEL, 
             ...
             size=0.05)
p4
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_PEL.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
```
