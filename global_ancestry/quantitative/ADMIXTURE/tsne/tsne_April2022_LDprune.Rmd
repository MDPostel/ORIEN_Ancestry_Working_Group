...
```{r}
Q1 <- read.table("HGDP_1000GP_Apr2022_LDfilter0.6.20.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
p <- p + ggtitle("TSNE of Admixture Results for K=20; D=2, Seed=9, Perplexity=50") + theme(plot.title = element_text(size=10, face="bold.italic")) + theme(plot.title = element_text(hjust = 0.5))
p
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_LDprune.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
...
p2
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_PUR_LDprune.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
...
p3 <- p + geom_point(data=MXL, 
             ...
             size=0.05)
p3
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_MXL_LDprune.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
...
p4 <- p + geom_point(data=PEL, 
             ...
             size=0.05)
p4
ggsave("K20_seed9_D2_perplexity50_admixture_TSNE_Apr2022_PEL_LDprune.jpeg", width=10, height=5, units="in", res=1000, device = jpeg)
```
