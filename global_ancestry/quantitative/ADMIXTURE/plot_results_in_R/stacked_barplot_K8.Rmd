...
```{r}
Q1 <- read.table("HGDP_1000GP.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
refs <- unique(refs)
write.csv(refs, "HGDP_1000GP_Q_K8.csv")
```
...
png("bar_plots_1000GP_and_HGDP_AFR_K8.png", width=10, height=5, units="in", res=1000)
...
png("bar_plots_1000GP_and_HGDP_AMR_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_CAS_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_MDE_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_OCE_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
#png("bar_plots_1000GP_and_HGDP_WEU_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
#p
#dev.off()
