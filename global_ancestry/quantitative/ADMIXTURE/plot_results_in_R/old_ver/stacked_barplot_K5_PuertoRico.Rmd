...
```{r}
#Q1 <- read.table("gnomAD_forPR.5.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
#raw_fam1 <- read.table("gnomAD_forPR.fam", head = FALSE, sep = " ", stringsAsFactors = FALSE)
Q1 <- read.table("admix/GNOMADisec.5.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
raw_fam1 <- read.table("admix/GNOMADisec.fam", head = FALSE, sep = " ", stringsAsFactors = FALSE)
...
png("bar_plots_gnomAD_PR_K5.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
ORIEN: Puerto Rican
```{r}
Q2 <- read.table("admix/ORIENisec_missing10.5.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
raw_fam2 <- read.table("admix/ORIENisec_missing10.fam", head = FALSE, sep = " ", stringsAsFactors = FALSE)
raw_fam2 <- raw_fam2[,c(1,2)]
names(raw_fam2)[1] <- "WES_ID"

samples <- cbind(Q2,raw_fam2)
samples <-samples[,c(6,1:5)]
...
png("bar_plots_ORIEN_PR_K5.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
# Simple stacked bar plot:
#extra code here to order AFR by central, E, S, W
p = ggplot(mdat, aes(x=factor(ID, level = unique(mdat$ID)), y=Fraction, fill=Ancestry)) +
...
#                       levels=names(sort(colSums(AFR[, 1:17]), decreasing=TRUE)))
# Colors taken from:
...
png("barplots_gnomAD_AFR_admixture_K5.png", width=10, height=5, units="in", res=1000)
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(AMR[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_AMR_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(CAS[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_CAS_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(EAS[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_EAS_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(EUR[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_EUR_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(MDE[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_MDE_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(OCE[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_OCE_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
# Sort ancestry order by overall 'abundance' of each ancestry.
#mdat$Ancestry = factor(mdat$Ancestry, 
#                       levels=names(sort(colSums(SAS[, 1:17]), decreasing=TRUE)))
# Colors taken from:
# https://github.com/mbostock/d3/wiki/Ordinal-Scales#category20
#col8 = c("#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd",
#          "#8c564b", "#e377c2", "#7f7f7f")
...
png("barplots_gnomAD_SAS_admixture_K5.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
