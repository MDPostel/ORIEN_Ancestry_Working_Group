...
```{r}
Q1 <- read.table("HGDP_1000GP.6.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
HGDP_1000GP <- HGDP_1000GP[,c(9,2:8)]
...
Q2 <- read.table("ORIEN_TCGA.6.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
HGDP_1000GP <- HGDP_1000GP[,c(1,9,3:8)]
...
refs <- unique(refs)
write.csv(refs, "HGDP_1000GP_Q_K6.csv")
```
...
write.csv(Race2, "ORIEN_TCGA_Q_K6_by_Race.csv")
...
write.csv(Eth2, "ORIEN_TCGA_Q_K6_by_Ethnicity.csv")
```
...
png("bar_plots_1000GP_and_HGDP_AFR_K6.png", width=10, height=5, units="in", res=1000)
...
png("bar_plots_1000GP_and_HGDP_AMR_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_CAS_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_MDE_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_OCE_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
#png("bar_plots_1000GP_and_HGDP_WEU_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
#p
#dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_White_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Black_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Asian_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_AIAN_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_PacIsl_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Unknown_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Other_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_HispanicLatino_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_NOTHispanicLatino_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_Unknown_K6.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
