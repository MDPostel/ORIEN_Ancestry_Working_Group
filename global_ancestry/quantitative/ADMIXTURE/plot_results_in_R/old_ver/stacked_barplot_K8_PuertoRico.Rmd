...
```{r}
#Q1 <- read.table("HGDP_1000GP_forPR.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
#raw_fam1 <- read.table("HGDP_1000GP_forPR.fam", head = FALSE, sep = " ", stringsAsFactors = FALSE)
Q1 <- read.table("HGDP_1000GP_ORIEN-PR_isec_Apr24_impute_refsonly.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
mdat = reshape2::melt(df, id.vars=c("ID", "1000GP_PR"), 
...
p = ggplot(mdat, aes(x=ID, y=Fraction, fill=Ancestry, order=Ancestry)) +
    ...
    facet_grid(. ~ `1000GP_PR`, drop=TRUE, space="free") +
...
png("bar_plots_1000GP_PR.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
ORIEN: Puerto Rican
```{r}
Q2 <- read.table("HGDP_1000GP_ORIEN-PR_isec_Apr24_impute_PRonly.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
```
```{r}
samples$pop <- "PuertoRico"
samples <- samples[,c(1,10,2:9)]
```
```{r}
df <- samples
df <- unique(df)
...
png("bar_plots_ORIEN_PR.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
#--------------
To understand color scheme, run all refs:
   A) 1000GP
...
png("bar_plots_1000GP_and_HGDP_AFR_1000GP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
...
png("bar_plots_1000GP_and_HGDP_AMR_1000GP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_1000GP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_1000GP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_1000GP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_AFR_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_AMR_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_CAS_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_MDE_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_OCE_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_HGDP_K8_PR-test.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
