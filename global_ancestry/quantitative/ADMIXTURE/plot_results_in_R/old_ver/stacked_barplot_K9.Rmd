...
```{r}
Q1 <- read.table("HGDP_1000GP.9.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
HGDP_1000GP <- HGDP_1000GP[,c(11,2:10)]
...
Q2 <- read.table("ORIEN_TCGA.9.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
HGDP_1000GP <- HGDP_1000GP[,c(1,11,2:10)]
...
Race <- Race[,c(1,11,2:10)]
Race <- unique(Race)

Ethnicity <- merge(x = samples, y = ethnicity, by="WES_ID")
Ethnicity <- Ethnicity[,c(1,11,2:10)]
...
refs <- unique(refs)
write.csv(refs, "HGDP_1000GP_Q_K9.csv")
```
...
write.csv(Race2, "ORIEN_TCGA_Q_K9_by_Race.csv")
...
write.csv(Eth2, "ORIEN_TCGA_Q_K9_by_Ethnicity.csv")
```
...
png("bar_plots_1000GP_and_HGDP_AFR_K9.png", width=10, height=5, units="in", res=1000)
...
png("bar_plots_1000GP_and_HGDP_AMR_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_CAS_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_MDE_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_OCE_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
#png("bar_plots_1000GP_and_HGDP_WEU_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
#p
#dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_White_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Black_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Asian_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_AIAN_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_PacIsl_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Unknown_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Other_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_HispanicLatino_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_NOTHispanicLatino_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_Unknown_K9.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
