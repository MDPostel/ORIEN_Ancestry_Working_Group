...
#Read in race/ethnicity info from ORIEN and TCGA.
```{r}
...
Read in reference population info from IGSR, 
```{r}
...
```{r}
Q1 <- read.table("HGDP_1000GP_Apr2022.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
raw_fam1 <- read.table("HGDP_1000GP_Apr2022.fam", head = FALSE, sep = " ", stringsAsFactors = FALSE)
...
HGDP_1000GP <- HGDP_1000GP[,c(10,2:9)]
...
HGDP_1000GP <- HGDP_1000GP[,c(1,10,2:9)]
...
Race <- Race[,c(1,10,2:9)]
Race <- unique(Race)

Ethnicity <- merge(x = samples, y = ethnicity, by="WES_ID")
Ethnicity <- Ethnicity[,c(1,10,2:9)]
Ethnicity <- unique(Ethnicity)
```

Save ref csv
```{r}
refs <- rbind(EUR,AFR,AMR,EAS,SAS,OCE,MDE,CAS)
refs <- unique(refs)
write.csv(refs, "HGDP_1000GP_Q_K8_Apr2022.csv")

refs_HGDP <- refs[grepl("HGDP",refs$WES_ID), ]
refs_1000GP <- anti_join(refs,refs_HGDP)
```
...
Race2 <- rbind(White, Asian, Black, Other, PacIsl, AIAN, UKrace)
write.csv(Race2, "ORIEN_TCGA_Q_K8_by_Race.csv")
...
Eth2 <- rbind(NHL,HL,UKeth)
write.csv(Ethnicity, "ORIEN_TCGA_Q_K8_by_Ethnicity.csv")
```
#ORIEN
```{r}
write.csv(NHL, "IDs_ORIEN_TCGA_NHL_pop_Q_K8_Apr2022.csv")
write.csv(HL, "IDs_ORIEN_TCGA_HL_Q_K8_Apr2022.csv")
write.csv(UKeth, "IDs_ORIEN_UnknownEthnicity_race_Q_K8_Apr2022.csv")
write.csv(White, "IDs_ORIEN_TCGA_White_Q_K8_Apr2022.csv")
write.csv(Asian, "IDs_ORIEN_TCGA_Asian_Q_K8_Apr2022.csv")
write.csv(Black, "IDs_ORIEN_TCGA_Black_Q_K8_Apr2022.csv")
write.csv(Other, "IDs_ORIEN_TCGA_OtherRace_Q_K8_Apr2022.csv")
write.csv(PacIsl, "IDs_ORIEN_TCGA_PacificIslander_Q_K8_Apr2022.csv")
write.csv(AIAN, "IDs_ORIEN_TCGA_AmericanIndian_Q_K8_Apr2022.csv")
write.csv(UKrace, "IDs_ORIEN_TCGA_UnknownRace_Q_K8_Apr2022.csv")
```

Save ref csvs by pop
```{r}
write.csv(EUR, "IDs_HGDP_1000GP_EUR_Q_K8_Apr2022.csv")
write.csv(AFR, "IDs_HGDP_1000GP_AFR_Q_K8_Apr2022.csv")
write.csv(AMR, "IDs_HGDP_1000GP_AMR_Q_K8_Apr2022.csv")
write.csv(SAS, "IDs_HGDP_1000GP_SAS_Q_K8_Apr2022.csv")
write.csv(EAS, "IDs_HGDP_1000GP_EAS_Q_K8_Apr2022.csv")
write.csv(OCE, "IDs_HGDP_1000GP_OCE_Q_K8_Apr2022.csv")
write.csv(MDE, "IDs_HGDP_1000GP_MDE_Q_K8_Apr2022.csv")
```
...
1) Reference populations:
    ...
    A) 1000GP
```{r}
AFR <- subset(refs_1000GP, pop == "AFR")
AMR <- subset(refs_1000GP, pop == "AMR")
EAS <- subset(refs_1000GP, pop == "EAS")
SAS <- subset(refs_1000GP, pop == "SAS")
OCE <- subset(refs_1000GP, pop == "OCE")
MDE <- subset(refs_1000GP, pop == "MDE")
EUR <- subset(refs_1000GP, pop == "EUR")
CAS <- subset(refs_1000GP, pop == "CAS")
```
...
png("bar_plots_1000GP_and_HGDP_AFR_1000GP_K8.png", width=10, height=5, units="in", res=1000)
...
png("bar_plots_1000GP_and_HGDP_AMR_1000GP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_1000GP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_1000GP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_1000GP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
#--------------
   B) HGDP
```{r}
AFR <- subset(refs_HGDP, pop == "AFR")
AMR <- subset(refs_HGDP, pop == "AMR")
EAS <- subset(refs_HGDP, pop == "EAS")
SAS <- subset(refs_HGDP, pop == "SAS")
OCE <- subset(refs_HGDP, pop == "OCE")
MDE <- subset(refs_HGDP, pop == "MDE")
EUR <- subset(refs_HGDP, pop == "EUR")
CAS <- subset(refs_HGDP, pop == "CAS")
```
...
png("bar_plots_1000GP_and_HGDP_AFR_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_AMR_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_CAS_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EAS_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_EUR_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_MDE_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_OCE_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_1000GP_and_HGDP_SAS_HGDP_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_White_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Black_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Asian_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_AIAN_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_PacIsl_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Unknown_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_race_Other_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_HispanicLatino_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_NOTHispanicLatino_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
...
png("bar_plots_ORIEN+TCGA_by_ethnicity_Unknown_K8.png", width=10, height=5, units="in", res=1000)
#grid.arrange(p, nrow=1)
p
dev.off()
