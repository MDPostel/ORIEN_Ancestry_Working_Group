...
```{r}
#Q1 <- read.table("gnomad.5.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
ORIEN: Puerto Rican
```{r}
#Q2 <- read.table("ORIEN.5.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
Q2 <- read.table("samples.5.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
