...
refs_numbered_ID_pop_Q <- refs_numbered_ID_pop_Q[,c(1,2,4:9)]
...
```
```{r}
White <- subset(samples_numbered_ID_race_Q, pop == "White")
```
```{r}
Asian <- subset(samples_numbered_ID_race_Q, pop == "Asian")     
```
```{r}
Black <- subset(samples_numbered_ID_race_Q, pop == "Black_or_African_American")            
```
```{r}
Other <- subset(samples_numbered_ID_race_Q, pop == "Other")    
```
```{r}
PacIsl <- subset(samples_numbered_ID_race_Q, pop == "Hawaiian_or_Other_Pacific_Islander")
```
```{r}
AIAN <- subset(samples_numbered_ID_race_Q, pop == "American_Indian_or_Alaska_Native")
```
```{r}
UK1 <- subset(samples_numbered_ID_race_Q, pop == "Unknown/Not_Reported")
```
```{r}
UK2 <- subset(samples_numbered_ID_race_Q, pop == "Unknown")
```
```{r}
UKrace <- rbind(UK1,UK2)       
```
```{r}
NHL <- subset(samples_numbered_ID_ethnicity_Q, pop == "Not_Hispanic/Not_Latino")
HL <- subset(samples_numbered_ID_ethnicity_Q, pop == "Hispanic/Latino")            
UK3 <- subset(samples_numbered_ID_ethnicity_Q, pop == "Unknown/Not_Reported")     
UK4 <- subset(samples_numbered_ID_ethnicity_Q, pop == "Unknown") 
UKeth <- rbind(UK3,UK4)
```
```{r}
write.csv(NHL, "IDs_ORIEN_TCGA_NHL_pop_Q.csv")
write.csv(HL, "IDs_ORIEN_TCGA_HL_Q.csv")
write.csv(UKeth, "IDs_ORIEN_UnknownEthnicity_race_Q.csv")
write.csv(White, "IDs_ORIEN_TCGA_White_Q.csv")
write.csv(Asian, "IDs_ORIEN_TCGA_Asian_Q.csv")
write.csv(Black, "IDs_ORIEN_TCGA_Black_Q.csv")
write.csv(Other, "IDs_ORIEN_TCGA_OtherRace_Q.csv")
write.csv(PacIsl, "IDs_ORIEN_TCGA_PacificIslander_Q.csv")
write.csv(AIAN, "IDs_ORIEN_TCGA_AmericanIndian_Q.csv")
write.csv(UKrace, "IDs_ORIEN_TCGA_UnknownRace_Q.csv")

write.csv(EUR, "IDs_HGDP_1000GP_EUR_Q.csv")
write.csv(AFR, "IDs_HGDP_1000GP_AFR_Q.csv")
write.csv(AMR, "IDs_HGDP_1000GP_AMR_Q.csv")
write.csv(SAS, "IDs_HGDP_1000GP_SAS_Q.csv")
write.csv(EAS, "IDs_HGDP_1000GP_EAS_Q.csv")
write.csv(OCE, "IDs_HGDP_1000GP_OCE_Q.csv")
write.csv(MDE, "IDs_HGDP_1000GP_MDE_Q.csv")
...
write.csv(refs_pop_samples_ethnicity_Q, "HGDP_1000GP_pops_ORIEN_TCGA_ethnicities_plusQ.csv")
...
write.csv(refs_pop_samples_ethnicity_Q, "HGDP_1000GP_pops_ORIEN_TCGA_races_plusQ.csv")
