...
```{r}
#Q1 <- read.table("gnomad.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
png("bar_plots_gnomAD_PR_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
ORIEN: Puerto Rican
```{r}
#Q2 <- read.table("ORIEN.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
Q2 <- read.table("samples.8.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
png("bar_plots_ORIEN_PR_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_AFR_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_AMR_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_CAS_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_EAS_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_EUR_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_MDE_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_OCE_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
...
png("barplots_gnomAD_SAS_admixture_K8.png", width=10, height=5, units="in", res=1000)
p
dev.off()
