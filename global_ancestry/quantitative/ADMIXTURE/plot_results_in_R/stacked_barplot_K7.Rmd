...
refpops2 <- rbind(refpops_HGDP2,refpops_1000GP2)
...
```{r}
Q <- read.table("isec.7.Q", head = FALSE,  sep = " ", stringsAsFactors = FALSE)
...
refs_numbered_ID_pop_Q <- refs_numbered_ID_pop_Q[,c(1,2,4:11)]
...
names(refs_numbered_ID_pop_Q)[9] <- "Q6"
names(refs_numbered_ID_pop_Q)[10] <- "Q7"
...
samples_numbered_ID_race_Q <- samples_numbered_ID_race_Q[,c(1,2,4:11)]
...
names(samples_numbered_ID_race_Q)[9] <- "Q6"
names(samples_numbered_ID_race_Q)[10] <- "Q7"
...
samples_numbered_ID_ethnicity_Q <- samples_numbered_ID_ethnicity_Q[,c(1,2,4:11)]
...
names(samples_numbered_ID_ethnicity_Q)[9] <- "Q6"
names(samples_numbered_ID_ethnicity_Q)[10] <- "Q7"
...
South_Asian_SGDP <- subset(refs_numbered_ID_pop_Q, pop == "South Asia (SGDP),South Asian Ancestry")
...
South_Asia_SGDP_Central_South_Asia_HGDP <- subset(refs_numbered_ID_pop_Q, pop == "South Asia (SGDP),Central South Asia (HGDP)")
...
```
```{r}
write.csv(NHL, "IDs_ORIEN_TCGA_NHL_pop_Q_K7.csv")
write.csv(HL, "IDs_ORIEN_TCGA_HL_Q_K7.csv")
write.csv(UKeth, "IDs_ORIEN_UnknownEthnicity_race_Q_K7.csv")
write.csv(White, "IDs_ORIEN_TCGA_White_Q_K7.csv")
write.csv(Asian, "IDs_ORIEN_TCGA_Asian_Q_K7.csv")
write.csv(Black, "IDs_ORIEN_TCGA_Black_Q_K7.csv")
write.csv(Other, "IDs_ORIEN_TCGA_OtherRace_Q_K7.csv")
write.csv(PacIsl, "IDs_ORIEN_TCGA_PacificIslander_Q_K7.csv")
write.csv(AIAN, "IDs_ORIEN_TCGA_AmericanIndian_Q_K7.csv")
write.csv(UKrace, "IDs_ORIEN_TCGA_UnknownRace_Q_K7.csv")

write.csv(EUR, "IDs_HGDP_1000GP_EUR_Q_K7.csv")
write.csv(AFR, "IDs_HGDP_1000GP_AFR_Q_K7.csv")
write.csv(AMR, "IDs_HGDP_1000GP_AMR_Q_K7.csv")
write.csv(SAS, "IDs_HGDP_1000GP_SAS_Q_K7.csv")
write.csv(EAS, "IDs_HGDP_1000GP_EAS_Q_K7.csv")
write.csv(OCE, "IDs_HGDP_1000GP_OCE_Q_K7.csv")
write.csv(MDE, "IDs_HGDP_1000GP_MDE_Q_K7.csv")

NHL2 <- NHL[,c(2:10)]; HL2 <- HL[,c(2:10)]; UKeth2 <- UKeth[,c(2:10)]
refs_pop_samples_ethnicity_Q <- rbind(NHL2, HL2, UKeth2, EUR, AFR, AMR, SAS, EAS, OCE, MDE)
write.csv(refs_pop_samples_ethnicity_Q, "HGDP_1000GP_pops_ORIEN_TCGA_ethnicities_plusQ_K7.csv")
White2 <- White[,c(2:10)]; Asian2 <- Asian[,c(2:10)]; Black2 <- Black[,c(2:10)]; Other2 <- Other[,c(2:10)]; PacIsl2 <- PacIsl[,c(2:10)]; AIAN2 <- AIAN[,c(2:10)]; UKrace2 <- UKrace[,c(2:10)]
refs_pop_samples_race_Q <- rbind(White2, Asian2, Black2, Other2, PacIsl2, AIAN2, UKrace2, EUR, AFR, AMR, SAS, EAS, OCE, MDE)
write.csv(refs_pop_samples_ethnicity_Q, "HGDP_1000GP_pops_ORIEN_TCGA_races_plusQ_K7.csv")
